...
import daribig.streaming.models.FlightData;
import daribig.streaming.models.UserStatistics;
import daribig.streaming.functions.ProcessUserStatisticsFunction;
...
public class UserStatisticsJob {
    public static void main(String[] args) throws Exception {
        ...
        try (InputStream stream = UserStatisticsJob.class.getClassLoader().getResourceAsStream("consumer.properties")) {
            consumerConfig.load(stream);
        }

        Properties producerConfig = new Properties();
        try (InputStream stream = UserStatisticsJob.class.getClassLoader().getResourceAsStream("producer.properties")) {
